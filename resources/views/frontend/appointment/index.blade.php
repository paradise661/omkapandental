...
@endsection
@section('content')
    <section id="appointment-hero" class="bg-gradient-to-br from-dental-light to-white h-[400px] flex items-center">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <h2 class="text-5xl font-bold text-gray-900 mb-6">{{ $appointment_page->title }}</h2>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-10">
                <form id="appointment-form" class="space-y-8">
                    ...
                    <div class="border-t border-gray-200 pt-8" id="step-2">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                            <span class="bg-dental-blue text-white rounded-full w-8 h-8 flex items-center justify-center text-sm mr-3">2</span>
                            Appointment Details
                        </h3>
                        <div class="grid grid-cols-2 gap-6">
                            <div>
                    ...
                    <div class="border-t border-gray-200 pt-8" id="step-3">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                            <span class="bg-dental-blue text-white rounded-full w-8 h-8 flex items-center justify-center text-sm mr-3">3</span>
                    ...
                    <div class="border-t border-gray-200 pt-8" id="step-4">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                            <span class="bg-dental-blue text-white rounded-full w-8 h-8 flex items-center justify-center text-sm mr-3">4</span>
                            Medical History
                        </h3>
                        <div class="space-y-4">
                            <div>
                    ...
                    <div class="border-t border-gray-200 pt-8" id="step-5">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                            <span class="bg-dental-blue text-white rounded-full w-8 h-8 flex items-center justify-center text-sm mr-3">5</span>
                    ...
                    <div class="flex justify-between items-center pt-6">
                        ...
                        <button type="submit" class="bg-dental-blue text-white px-12 py-4 rounded-lg text-lg font-semibold hover:bg-blue-700 transition">
