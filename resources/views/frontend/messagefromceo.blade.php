    ...
    <section class="py-10">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <!-- Image -->
                <div class="flex items-center justify-center" data-aos="fade-right" data-aos-duration="3000">
                    <div class="about-us-img-ceo">
                        <img class="rounded-lg" src="{{ asset($message_page->banner_image) }}"
                            alt="{{ $message_page->title }}" />
                    </div>
                </div>

                <!-- Content -->
                <div class="flex items-center justify-center" data-aos="fade-left" data-aos-duration="3000">
                    <div class="service-content-container text-center lg:text-left">
                        <h6 class="my-2">
                            <strong> {{ $message_page->title ?? 'About us' }}</strong>
                        </h6>

                        <h3 class="my-2">
                            <strong> {{ $message_page->short_description }}</strong>
                        </h3>
